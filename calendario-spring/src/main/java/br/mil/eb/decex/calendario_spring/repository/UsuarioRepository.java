...
public interface UsuarioRepository extends JpaRepository<Usuario, Long> {
    ...
    // "  ELSE 999 END ASC")
    // Page<Usuario> findByNomeGuerraOrAssessoria(String termo, Pageable pageable);

    // // Ou método derivado
    // Page<Usuario> findByNomeGuerraContainingIgnoreCaseOrAssessoria_SiglaContainingIgnoreCase(String nomeGuerra, String sigla, Pageable pageable);
}

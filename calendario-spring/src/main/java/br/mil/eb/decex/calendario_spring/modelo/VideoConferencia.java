...
public class VideoConferencia {
    ...
    @Id
    @SequenceGenerator(name = "VIDEOCONFERENCIA_ID_GENERATOR", sequenceName = "VIDEOCONFERENCIA_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "VIDEOCONFERENCIA_ID_GENERATOR")
    @JsonProperty("_id")
    private Long id;
    ...
    @CollectionTable(name = "videoConferencia_acessorios", joinColumns = @JoinColumn(name = "videoConferencia_id"))
    @Column
    ...
    public String toString() {
        return "VideoConferencia [id=" + id + ", dataInicio=" + dataInicio + ", dataFim=" + dataFim + ", horaInicio=" + horaInicio + ", horaFim=" + horaFim

...
public class Auditorio {
    ...
    @Id
    @SequenceGenerator(name = "AUDITORIO_ID_GENERATOR", sequenceName = "AUDITORIO_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "AUDITORIO_ID_GENERATOR")
    @JsonProperty("_id")
    private Long id;
    ...
    @CollectionTable(name = "auditorio_acessorios", joinColumns = @JoinColumn(name = "auditorio_id"))
    @Column
    ...
    public String toString() {
        return "Auditorio [id=" + id + ", dataInicio=" + dataInicio + ", dataFim=" + dataFim + ", horaInicio=" + horaInicio + ", horaFim=" + horaFim

...
public class Calendario {
    ...
    @CollectionTable(name = "calendario_acessorios", joinColumns = @JoinColumn(name = "calendario_id"))
    @Column
    ...
    public String toString() {
        return "Calendario [id=" + id + ", data=" + data + ", horaInicio=" + horaInicio + ", horaFim=" + horaFim
